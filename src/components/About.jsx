        ...
        <div className="container mx-auto px-5 max-w-[1140px]">
            <div className="flex flex-col md:flex-row justify-between pt-28 lg:pt-40">
                ...
                <div className="md:w-2/4 md:ps-10">
                    ...
                    <div className="border border-solid p-[6px] rounded-sm mt-8 lg:mt-11  inline-block"><button className='px-[10.5px] pt-[5.2px] pb-[4px] bg-[#FF7D01] text-white rounded-sm  font-Black_Sans leading-[150%]  common_btn hover:bg-transparent inline-block ' >Connect Wallet</button></div>
                </div>
            </div>
        </div>
    )
