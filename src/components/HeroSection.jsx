    ...
    return (
        <div className="bg_img_hero">
            ...
            <div classNme="container mx-auto  max-w-[1140px]">
                <div className="flex justify-center flex-col items-center absolute -bottom-40 left-2/4 -translate-x-2/4 w-full px-5">
                    ...
                    <div className="border   border-solid p-[6px] rounded-sm mt-8 "><button className='px-[10.5px] pt-[5.2px] pb-[4px] bg-[#FF7D01] text-white  rounded-sm  font-Black_Sans leading-[150%]  common_btn hover:bg-transparent inline-block ' >Mint Now</button></div>
                </div>
